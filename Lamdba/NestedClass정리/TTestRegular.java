...
public class TTestRegular {
    ...
    public static void main(String[] args) {
        ...
        Arrays.sort(students, new StudentNumberScoreComparator());
    ...
    // regular inner class: StudentNumberScoreComparator
    class StudentNumberScoreComparator implements Comparator<Student> {
        @Override
    ...
    // regular inner class: StudentNameComparator
